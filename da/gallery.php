...
<html lang="en">
    <head>
        <title>Pernille Bernitt Sommer - Galleri</title>
        <meta charset="utf-8">
    ...
    <body>
        <div class="responsiveMenuContainer" id="responsiveMenuContainer" style="display: none;">
            ...
            <a href="gallery.php"><div class="responsiveMenuItem active">GALLERI</div></a>
        ...
        <header id="header">
            <div class="content">
                ...
                <nav id="headerNavigation">
                    ...
                    <a href="gallery.php" class="active">GALLERI</a>
                    ...
                    <div class="flagDropDown" id="flagDropDown">
                        ...
                        <a class="chooseLanguage" href="gallery.php"><img src="img/da.png" class="flag"></a>
                    </div>
                </nav>
            </div>
        </header>
